...
export default function ArchivPage() {
  ...
  return (
    <main style={wrap}>
      <Header title="Archiv" role={role} canWrite={canWrite} />
      <Card>
        <p style={lead}>Platzhalter – Archiv folgt.</p>
        <p style={text}>Geplant: historische Einsätze, Export/Download, Filter.</p>
