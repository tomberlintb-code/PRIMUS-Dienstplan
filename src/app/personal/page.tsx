...
export default function PersonalPage() {
  ...
  return (
    <main style={wrap}>
      <Header title="Personalabteilung" role={role} canWrite={canWrite} />
      <Card>
        <p style={lead}>Platzhalter – Personalabteilung folgt.</p>
        <p style={text}>Später: Stammdaten, Urlaubsworkflow, Nachweise, Qualifikationen…</p>
